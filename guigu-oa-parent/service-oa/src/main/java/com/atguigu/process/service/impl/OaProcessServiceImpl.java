...
public class OaProcessServiceImpl extends ServiceImpl<OaProcessMapper, Process> implements OaProcessService {
    ...
    public void deployZip(String deployPath) {
        InputStream inputStream = this.getClass().getResourceAsStream(deployPath);
    ...
    public void startUp(ProcessFormVo processFormVo) {
        ...
        //将processFormVo数据复制到process对象里面
    ...
    public IPage<ProcessVo> findPending(Page<Process> pageParam) {
        ...
        //3.封装返回list集合，到List<ProcessVo>里面
    ...
    public void approve(ApprovalVo approvalVo) {
        //1.从approvalVo获取任务id，根据任务id获取流量变量
    ...
    private void endTask(String taskId) {
        ...
        newSequenceFlow.setSourceFlowElement(currentFlowNode);//起始点
        newSequenceFlow.setTargetFlowElement(endFlowNode);//结束点
        //7.当前节点指向新方向
